...
ON		-- ïàðàìåòð ON çàäà¸ò ñâîéñòâî ôàéëà ñîçäàâàåìîé áàçû
(
	NAME		= PD_411_all_in_one, --ËÎÃÈ×ÅÑÊÎÅ ÈÌß ÔÀÉËÀ
	FILENAME	= 'D:\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\Data\PD_411_all_in_one.mdf',--ÔÈÇÈ×ÅÑÊÎÅ ÈÌß ÔÀÉËÀ
	SIZE		= 8MB,
	MAXSIZE		= 500MB,
	FILEGROWTH	= 5MB
)
LOG ON	-- ýòîò ïàðàìåòð çàäà¸ò ñâîéñòâî ôàéëà æóðíàëà áàçû äàííûõ
(
	NAME		= PD_411_all_in_one_Log,
	FILENAME	= 'D:\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\Data\PD_411_all_in_one_log.ldf',--ÔÈÇÈ×ÅÑÊÎÅ ÈÌß ÔÀÉËÀ
	SIZE		= 8MB,
	MAXSIZE		= 500MB,
	FILEGROWTH	= 8MB
);
